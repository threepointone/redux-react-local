...
function makeStore() {
  ...
  // reducer
  (0, _reduxOptimist2.default)((0, _redux.combineReducers)(_extends({}, reducers || {}, {
...
var Root = (_temp2 = _class = function (_Component) {
  ...
  function Root() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Root)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.sagaMiddleware = (0, _reduxSaga2.default)(), _this.store = makeStore(_this.props.reducers, _this.props.initial, _this.middle()), _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  middleware: _react.PropTypes.array,
