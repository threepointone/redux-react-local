    ...
    return _temp2 = _class = function (_Component) {
      ...
      function ReduxReactLocal() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ReduxReactLocal)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.store = _this.context.store, _this.state = function () {
          ...
          return {
            id: id,
            value: whenUndefined(_this.store.getState().local[id], getInitial(_this.props))
          };
      ...
      _createClass(ReduxReactLocal, [{
        ...
        value: function componentWillMount() {
          ...
          if (isBrowserLike) {
            this.dispose = this.store.subscribe(function () {
              var value = _this2.store.getState().local[_this2.state.id];
        ...
        value: function componentWillReceiveProps(next) {
          ...
          if (id !== this.state.id) {
            ...
            this.setState({ id: id, value: whenUndefined(this.store.getState().local[id], init) });
          }
        }
      }, {
