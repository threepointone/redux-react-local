...
function local() {
  ...
  return function (Target) {
    ...
    return _dec = (0, _reactRedux.connect)(function (state, props) {
      if (!state.local) {
      ...
      function ReduxReactLocal() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ReduxReactLocal)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
          ...
          value: _this.props.$$local !== undefined ? _this.props.$$local : getInitial(_this.props)
      ...
      _createClass(ReduxReactLocal, [{
        ...
        value: function render() {
          return _react2.default.createElement(
            Target,
            _extends({}, omit(this.props, '$$local'), {
              $: this.$,
              ident: this.state.id,
    ...
    }(_react.Component), _class2.displayName = 'local:' + (Target.displayName || Target.name), _temp2)) || _class;
  };
}