...
var Root = exports.Root = _wrapComponent('Root')((_temp2 = _class = function (_Component) {
  ...
  function Root() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Root)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.sagas = (0, _reduxSaga2.default)(), _this.store = (0, _redux.createStore)((0, _redux.combineReducers)(_extends({}, _this.props.reducers, {
      ...
      // initial state
    }, _redux.applyMiddleware.apply(undefined, _toConsumableArray(_this.props.middleware).concat([_this.sagas]))), _temp), _possibleConstructorReturn(_this, _ret);
  }
...
function localReducer() {
  ...
  if (type === 'local.register') {
    ...
    return _extends({}, state, (_extends3 = {}, _defineProperty(_extends3, payload.id, state[payload.id] || payload.initial), _defineProperty(_extends3, 'registered', _extends({}, state.registered, _defineProperty({}, payload.id, {
  ...
  if (type === 'local.unmount') {
    return _extends({}, state, {
      ...
      registered: _extends({}, state.registered, _defineProperty({}, payload.id, {
  ...
  var reduced = Object.keys(state.registered).reduce(function (o, key) {
    ...
    return Object.assign(o, _defineProperty({}, key, state.registered[key].reducer(state[key], a)));
  }, {});
  ...
  return function (Target) {
    ...
    return (0, _reactRedux.connect)(function (state, props) {
      ...
      function ReduxReactLocal() {
        ...
        }, _this2.$ = function (type, payload) {
          return {
            type: getId(_this2.props) + ':' + type,
            payload: payload,
            meta: {
      ...
      _createClass(ReduxReactLocal, [{
        ...
        value: function componentDidMount() {
          ...
          if (saga) {
            this.runningSaga = this.context.sagas.run(saga, { $: this.$, id: getId(this.props), getState: function getState() {
                return _this3.props.local || getInitial(_this3.props);
              } });
          }
        }
      }, {
