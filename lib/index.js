...
function localReducer() {
  ...
  if (type === 'local.register') {
    ...
    state = _extends({}, state, (_extends3 = {}, _defineProperty(_extends3, payload.ident, state[payload.ident] !== undefined ? state[payload.ident] : payload.initial), _defineProperty(_extends3, 'registered', _extends({}, state.registered, _defineProperty({}, payload.ident, {
  ...
  if (type === 'local.unmount') {
    ...
    state = _extends({}, state, (_extends5 = {}, _defineProperty(_extends5, payload.ident, payload.persist ? state[payload.ident] : undefined), _defineProperty(_extends5, 'registered', _extends({}, state.registered, _defineProperty({}, payload.ident, {
